...
//promios
class cPromiosConfig
{
	function cPromiosConfig()
	{
		$caller =& $this;
		require_once('./../../../../config/all.cfg.php');
	}
}
global $promiosConfig;
$promiosConfig = new cPromiosConfig();
...
function CheckAuthentication()
{
	...
	//promios
	global $promiosConfig;
	return !empty($_SESSION[$promiosConfig->prefix . 'login']);
...
*/
//promios
$baseDir = str_replace('di/', '', $promiosConfig->frontend_srv_rw_dir);
...
$config['ResourceType'][] = Array(
		...
		//promios
		'url' => $baseUrl . 'di',
		'directory' => $baseDir . 'di',
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,fpng',
		'deniedExtensions' => '');
...
*/
$config['ChmodFiles'] = 0604 ;

/*
See comments above.
Used when creating folders that does not exist.
*/
$config['ChmodFolders'] = 0705 ;
