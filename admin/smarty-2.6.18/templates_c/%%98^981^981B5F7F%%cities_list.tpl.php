<?php /* Smarty version 2.6.30, created on 2017-01-26 18:20:45
         compiled from cities_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'pane', 'cities_list.tpl', 2, false),array('function', 'tree', 'cities_list.tpl', 3, false),array('function', 'pagination_pane', 'cities_list.tpl', 3, false),array('modifier', 'escape', 'cities_list.tpl', 5, false),)), $this); ?>
...
<?php echo $this->_plugins['function']['tree'][0][0]->tree(array('cols' => '"100%", "1"','headers' => $this->_tpl_vars['list_headers'],'values' => $this->_tpl_vars['list_values'],'tab' => 5), $this);?>
<?php echo $this->_plugins['function']['pagination_pane'][0][0]->pagination_pane(array('pagination' => $this->_tpl_vars['pagination'],'tab' => 5), $this);?>
