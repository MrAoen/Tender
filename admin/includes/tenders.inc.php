...
class cTenders
{
    ...
    function output_list()
    {
        ...
        $tender_fields = array(
            ...
            'startts' => array(
                'caption' => 'Дата начала',
                'hint' => 'Дата начала тендера',
            ),
            'length' => array(
                'caption' => 'Продолжительность',
                'hint' => 'Продолжительность тендера',
            ),
            'loadingcityid' => array(
                'caption' => 'Город погрузки',
                'hint' => 'Город погрузки',
            ),
            'loadingaddress' => array(
            ...
            'loadingts' => array(
                ...
                'hint' => 'Дата прибытия на погрузку',
            ),
            'course' => array(
                'caption' => 'Точки доставки',
                'hint' => 'Точки доставки',
            ),
            'volume' => array(
                'caption' => 'Объем груза',
            ...
            'body_ru' => array(
                ...
                'hint' => 'Дополнительное описание тендера',
            ),
            'pricestart' => array(
            ...
            'pricewin' => array(
                'caption' => 'Призовая цена',
                'hint' => 'Призовая цена',
            ),
            'pricecurrent' => array(
                'caption' => 'Предложенная цена',
                'hint' => 'Текущая минимальная предложенная цена (в т.ч. и большая начальной)',
            ),
            'lastuserid' => array(
                'caption' => 'Победитель',
                'hint' => 'Компания-перевозчик, выигравшая тендер',
            ),
            'propositions' => array(
                'caption' => 'Предложения',
                'hint' => 'Количество предложений',
            ),
            'iscomplete' => array(
                'caption' => 'Завершен',
                'hint' => 'Тендер завершен?',
            ),
        );
        $cheader = array();
                ...
                if (!empty($this->params[$k])) {
                    ...
                    switch ($k) {
                        ...
                        case 'propositions':
                            ...
                            break;
                        case 'iscomplete':
                            $fields[strval($j)]['caption'] = ($res[$k] == 1 ? 'да' : 'нет');
                            $fields[strval($j)]['col_params'] = array('class' => 'spacer-right');
                            break;
                    }
                    ++$j;
    ...
    function output_form()
    {
        ...
        $proplist = array(
            'caption' => 'Список предложений',
            'hint' => 'Предложения перевозчиков',
            'items' => array(),
        );
